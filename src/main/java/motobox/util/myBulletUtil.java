...
public class myBulletUtil
{
    public static Vec3d horiSpread(GangEntity player, float x_spread)
    {
    ...
    public static Vec3d vertiSpread(GangEntity player, float y_spread)
    {
