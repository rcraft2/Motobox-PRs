...
public class GunAttackGoal<T extends SkeletonEntity> extends Goal {
    ...
    public GunAttackGoal(T actor, double speed, int attackInterval, float range) {
        this.actor = actor;
        this.speed = speed;
    ...
    protected boolean isHoldingBow() {
        return this.actor.isHolding(ModItems.MACHINE_PISTOL);
    }
    ...
    public void tick() {
        ...
        if (livingEntity != null) {
            ...
            if (!bl && this.targetSeeingTicker < -60) {
                ...
                this.actor.clearActiveItem();
                ((RangedAttackMob)this.actor).attack(livingEntity, BowItem.getPullProgress(2));
