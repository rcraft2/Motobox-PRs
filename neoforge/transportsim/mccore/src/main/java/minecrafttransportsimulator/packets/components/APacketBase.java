...
import minecrafttransportsimulator.packets.instances.PacketVehiclePurchaseGUIOpen;
...
public abstract class APacketBase {
    ...
    public static void initPackets(byte packetIndex) {
        ...
        InterfaceManager.packetInterface.registerPacket(packetIndex++, PacketPlayerMoneyUpdate.class);
        ...
        InterfaceManager.packetInterface.registerPacket(packetIndex++, PacketVehiclePurchaseRequest.class);
        InterfaceManager.packetInterface.registerPacket(packetIndex++, PacketVehiclePurchaseGUIOpen.class);
