...
public class GUIOverlay extends AGUIBase {
    ...
    private GUIComponentLabel moneyLabel;
    ...
    public void setupComponents() {
        ...
        addComponent(moneyLabel = new GUIComponentLabel(screenWidth - 10, 12, ColorRGB.GREEN, "", TextAlignment.RIGHT_ALIGNED, 1.1F));
        moneyLabel.ignoreGUILightingState = true;
    ...
    public void setStates() {
        ...
        moneyLabel.text = MoneySystem.getFormattedClientBalance();
        moneyLabel.position.set(screenWidth - 10, 12, moneyLabel.position.z);
