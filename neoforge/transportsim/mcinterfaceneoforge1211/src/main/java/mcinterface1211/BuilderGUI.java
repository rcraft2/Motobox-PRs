...
public class BuilderGUI extends Screen {
    ...
    /**
     * Override to disable the background blur/darkening that MC 1.21 adds by default.
     * MTS handles its own GUI rendering, so the vanilla blur just gets in the way.
     */
    @Override
    public void renderBackground(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        //No-op: don't render vanilla background blur or darkening.
    }
